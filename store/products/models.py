...
class Product(models.Model):
    ...
    slug = models.SlugField(unique=True)
    image_small = models.ImageField(upload_to='media/products/small/',
                                    verbose_name="Маленькое изображение продукта",
                                    help_text="Изображение продукта в маленьком размере")
    image_medium = models.ImageField(upload_to='media/products/medium/',
                                     verbose_name="Среднее изображение",
                                     help_text="Изображение продукта в среднем размере")
    image_large = models.ImageField(upload_to='media/products/large/',
